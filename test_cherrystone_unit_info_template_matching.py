...
class TestCherrystoneUnitInfoTemplateMatching(unittest.TestCase):
    ...
    def test_mercia_info_panel_specifies_movement_walking_4(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_commander_mercia',
                                               mercia_info_panel_test,
                                               unit_constants.cherrystone_mercia_standard_template_matching_corr_coeff_threshold)
    ...
    def test_emeric_info_panel_specifies_movement_walking_4(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_commander_emeric',
                                               emeric_info_panel_test,
                                               unit_constants.cherrystone_emeric_standard_template_matching_corr_coeff_threshold)
    ...
    def test_caesar_info_panel_specifies_movement_walking_4(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_commander_caesar',
                                               caesar_info_panel_test,
                                               unit_constants.cherrystone_caesar_standard_template_matching_corr_coeff_threshold)
    ...
    def test_villager_info_panel_specifies_movement_walking_3(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_villager',
                                               villager_info_panel_test,
                                               unit_constants.cherrystone_villager_standard_template_matching_corr_coeff_threshold)
    ...
    def test_soldier_info_panel_specifies_movement_walking_4(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_soldier',
                                               soldier_info_panel_test,
                                               unit_constants.cherrystone_soldier_standard_template_matching_corr_coeff_threshold)
    ...
    def test_pikeman_info_panel_specifies_movement_walking_3(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_pikeman',
                                               pikeman_info_panel_test,
                                               unit_constants.cherrystone_pikeman_standard_template_matching_corr_coeff_threshold)
    ...
    def test_battle_pup_info_panel_specifies_movement_walking_5(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_battle_pup',
                                               battle_pup_info_panel_test,
                                               unit_constants.cherrystone_battlepup_standard_template_matching_corr_coeff_threshold)
    ...
    def test_alchemist_info_panel_specifies_movement_walking_5(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_alchemist',
                                               alchemist_info_panel_test,
                                               unit_constants.cherrystone_alchemist_standard_template_matching_corr_coeff_threshold)
    ...
    def test_archer_info_panel_specifies_movement_walking_3(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_archer',
                                               archer_info_panel_test,
                                               unit_constants.cherrystone_archer_standard_template_matching_corr_coeff_threshold)
    ...
    def test_golem_info_panel_specifies_movement_walking_5(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_golem',
                                               golem_info_panel_test,
                                               unit_constants.cherrystone_golem_standard_template_matching_corr_coeff_threshold)
    ...
    def test_knight_info_panel_specifies_movement_riding_6(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_knight',
                                               knight_info_panel_test,
                                               unit_constants.cherrystone_knight_standard_template_matching_corr_coeff_threshold)
    ...
    def test_wagon_info_panel_specifies_movement_wheels_12(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_wagon',
                                               wagon_info_panel_test,
                                               unit_constants.cherrystone_wagon_standard_template_matching_corr_coeff_threshold)
    ...
    def test_ballista_info_panel_specifies_movement_wheels_6(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_ballista',
                                               ballista_info_panel_test,
                                               unit_constants.cherrystone_ballista_standard_template_matching_corr_coeff_threshold)
    ...
    def test_trebuchet_info_panel_specifies_movement_wheels_6(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_trebuchet',
                                               trebuchet_info_panel_test,
                                               unit_constants.cherrystone_trebuchet_standard_template_matching_corr_coeff_threshold)
    ...
    def test_balloon_info_panel_specifies_movement_flying_6(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_balloon',
                                               balloon_info_panel_test,
                                               unit_constants.cherrystone_balloon_standard_template_matching_corr_coeff_threshold)
    ...
    def test_harpy_info_panel_specifies_movement_flying_5(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_harpy',
                                               harpy_info_panel_test,
                                               unit_constants.cherrystone_harpy_standard_template_matching_corr_coeff_threshold)
    ...
    def test_witch_info_panel_specifies_movement_flying_7(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_witch',
                                               witch_info_panel_test,
                                               unit_constants.cherrystone_witch_standard_template_matching_corr_coeff_threshold)
    ...
    def test_emberwing_info_panel_specifies_movement_flying_8(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_emberwing',
                                               emberwing_info_panel_test,
                                               unit_constants.cherrystone_dragon_standard_template_matching_corr_coeff_threshold)
    ...
    def test_barge_info_panel_specifies_movement_water_10(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_barge',
                                               barge_info_panel_test,
                                               unit_constants.cherrystone_barge_standard_template_matching_corr_coeff_threshold)
    ...
    def test_sea_turtle_info_panel_specifies_movement_water_12(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_sea_turtle',
                                               sea_turtle_info_panel_test,
                                               unit_constants.cherrystone_seaturtle_standard_template_matching_corr_coeff_threshold)
    ...
    def test_harpoon_ship_info_panel_specifies_movement_water_4(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_harpoon_ship',
                                               harpoon_ship_info_panel_test,
                                               unit_constants.cherrystone_harpoonship_standard_template_matching_corr_coeff_threshold)
    ...
    def test_warship_info_panel_specifies_movement_water_8(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_warship',
                                               warship_info_panel_test,
                                               unit_constants.cherrystone_warship_standard_template_matching_corr_coeff_threshold)
    ...
    def test_merfolk_info_panel_specifies_movement_amphibious_5(self):
        ...
        self.open_unit_info_panel_and_run_test('cherrystone_merfolk',
                                               merfolk_info_panel_test,
                                               unit_constants.cherrystone_merfolk_standard_template_matching_corr_coeff_threshold)

    @staticmethod
    def open_unit_info_panel_and_run_test(unit_template_name,
                                          panel_test,
                                          threshold):
        ...
        while match is None and attempts < 5:
            ...
            match = wargroove_ctrl.mouse_over_unit(unit_template_name, threshold=threshold)
        if match is None:
            assert_that(False).described_as('unit found').is_true()
        time.sleep(0.1)
