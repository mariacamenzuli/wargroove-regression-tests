...
class TestProjectEvaluationMenuHighRes(unittest.TestCase):
    ...
    def test_in_game_mercia_portrait_standard_template_matching_cross_corr_img4(self):
        ...
        wargroove_ctrl.vision.load_frame(self.__get_eval_folder() + 'in-game/hud-mirror/portrait-mercia-high-res.png')
        match = wargroove_ctrl.find_ui_item_with_template_matching('gameplay/wargroove_mercia_portrait',
                                                                   threshold=threshold)

        assert_that(match).is_not_none()
        assert_that(match.top_left[0]).is_close_to(20, 1)
        assert_that(match.top_left[1]).is_close_to(20, 1)
        assert_that(match.bottom_right[0]).is_close_to(126, 1)
        assert_that(match.bottom_right[1]).is_close_to(130, 1)
    ...
    def test_in_game_emeric_portrait_standard_template_matching_cross_corr_img4(self):
        threshold = unit_constants.ui_standard_template_matching_threshold
        wargroove_ctrl.vision.load_frame(self.__get_eval_folder() + 'in-game/hud-mirror/portrait-emeric-high-res.png')
    ...
    def test_in_game_caesar_portrait_standard_template_matching_cross_corr_img4(self):
        threshold = unit_constants.ui_standard_template_matching_threshold
        wargroove_ctrl.vision.load_frame(self.__get_eval_folder() + 'in-game/hud-mirror/portrait-caesar-high-res.png')
